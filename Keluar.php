              ...
              <!-- Tabel -->
                ...
                <div class="table-responsive text-nowrap">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <td><?= $keterangan; ?></td>
                        <td>
                            <button type="button" class="btn btn-warning my-1 mx-1" data-bs-toggle="modal" data-bs-target="#edit<?= $idk; ?>">
                            Edit
                            </button>
                            <button type="button" class="btn btn-danger my-1 mx-1" data-bs-toggle="modal" data-bs-target="#hapus<?= $idk; ?>">
                            Delete
                            </button>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <button type="submit" name="updatebarangkeluar" class="btn btn-primary">Simpan</button>
                                </div>
                            </div>
                            </form>
                        </div>
                        ...
                        <!-- Modal Hapus -->
                        <div class="modal fade" id="hapus<?= $idk; ?>" tabindex="-1">
                        <div class="modal-dialog">
                            <form method="post">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                <p>Yakin ingin menghapus data ini (<?= $namabarang; ?>)?</p>
                                <input type="hidden" name="idb" value="<?= $idb; ?>">
  ...
  <!-- Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                <select name="barangnya" class="form-control" id="select-barang">
                <option value="">-- Pilih Barang --</option>
                    ...
                    ?>
                        <option value="<?=$idbarangnya;?>" data-kode="<?=$kodebarangnya;?>">
                            <?=$namabarangnya;?>
                        </option>
                    <?php } ?>
                </select>
                    ...
                    <br>
                    <input type="text" name="penerima" placeholder="Lokasi" class="form-control" required>
                    <br>
