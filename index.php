            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- Tombol untuk memicu modal -->
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-primary w-auto my-2 ms-3" data-bs-toggle="modal" data-bs-target="#basicModal">
                        Tambah Barang
                    </button>
                    <!-- Search -->
                      ...
                      <tbody class="table-border-bottom-0">
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?=$tahun;?></td>
                            <td>
                              <button type="button" class="btn btn-warning my-1 mx-1" data-bs-toggle="modal" data-bs-target="#edit<?=$idb;?>">
                                Edit
                              </button>
                              <button type="button" class="btn btn-danger my-1 mx-1" data-bs-toggle="modal" data-bs-target="#delete<?=$idb;?>">
                                Delete
                              </button>
                            </td>
                          </tr>
                                ...
                                <div class="modal-content">
                                  <form method="post">
                                    ...
                                    <div class="modal-body">
                                      ...
                                      <input type="number" name="tahun" value="<?=$tahun;?>" class="form-control" required><br> <!-- Input untuk Tahun -->
    ...
    <div class="modal-content">
      ...
      <form method="post">
        <div class="modal-body">
          ...
          <input type="text" name="satuan" placeholder="Satuan Barang" class="form-control" required><br>
          <input type="number" name="stock" placeholder="Jumlah Stock" class="form-control" required><br>
          <input type="number" name="harga" placeholder="Harga Satuan" class="form-control" required><br>
          <input type="text" name="lokasi" placeholder="Lokasi Barang" class="form-control" required><br>
